...
namespace App\Filament\Reviewer\Resources\ChangePasswordResource\Pages;
    ...
    protected function getHeaderActions(): array
    {
        return [
            Actions\Action::make('change_my_password')
                ...
                ->icon('heroicon-o-key')
                ->color('primary')
                ->url(fn () => \App\Filament\Student\Resources\ChangePasswordResource::getUrl('edit', ['record' => Auth::id()]))
