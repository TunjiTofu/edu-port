    ...
    protected function getHeaderActions(): array
    {
        return [
            ...
            Actions\DeleteAction::make()
                ...
                ->modalHeading('Delete Church')
                ->modalDescription('Are you sure you want to delete this church? This action can be undone.')
                ->successNotificationTitle('Church deleted successfully'),
            Actions\RestoreAction::make()
                ->successNotificationTitle('Church restored successfully'),
            Actions\ForceDeleteAction::make()
                ->requiresConfirmation()
                ->modalHeading('Permanently Delete Church')
                ->modalDescription('Are you sure you want to permanently delete this church? This action cannot be undone.')
                ->successNotificationTitle('Church permanently deleted'),
        ];
    }
                    ...
                    ->headerActions([
                        Action::make('viewDistrict')
                            ...
                            ->url(fn($record) => $record->district ?
                                route('filament.admin.resources.districts.view', $record->district) : null)
