...
use App\Filament\Observer\Resources\UserResource\Pages;
use App\Filament\Observer\Resources\UserResource\RelationManagers;
...
//        ]);
        ...
        // If current user is observer, only show students
        if (auth()->user()?->isObserver()) {
            $query->whereHas('role', function($q) {
                $q->where('role_id', Constants::STUDENT_ID);
            });
        }
