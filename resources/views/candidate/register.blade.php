...
<div class="w-full max-w-lg mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
    ...
    {{-- Progress bar — only shown when registration is open --}}
    @if ($registrationOpen)
        <div class="flex">
    ...
    <div class="px-6 pb-8 pt-3">
        ...
        @if (! $registrationOpen)
            <div class="mb-2 p-5 bg-red-50 border-2 border-red-200 rounded-xl text-center">
                <div class="text-4xl mb-3">🚫</div>
                <h2 class="text-base font-bold text-red-700 mb-2">Registration Closed</h2>
                <p class="text-sm text-red-600 leading-relaxed">{{ $registrationMessage }}</p>
                <div class="mt-4 pt-4 border-t border-red-200">
                    <p class="text-xs text-red-500">
                        If you believe this is an error, please contact your district coordinator or the program administrator.
                    </p>
                </div>
                <a href="/" class="mt-4 inline-block text-sm font-semibold text-red-700 underline underline-offset-2">← Back to Home</a>
            </div>
        @else
...
@endif {{-- end @else (registration open) --}}
</body>
</html>
